    ...
    while (agenda.menu != TELA_SAIR)
    {
        switch(agenda.menu)
        {
            case TELA_PRINCIPAL:
                {
                    ...
                    if (opcao == 1)
                    {
                        ...
                        {
                            printf("\tAgenda estah lotada, nao eh possivel novos contatos\n");
                            agenda.menu = TELA_PRINCIPAL;
                        }
                    }
                    if (opcao == 2)
            ...
            case TELA_CADASTRAR:
                {
                    ...
                    do
                    {
                        ...
                        while (novo.nome[id] != '\0' && novo.nome[id] != '\n')
                            id++;
                        novo.nome[id] = '\0';
                        printf("Digite um novo telefone para contato: \n");
            ...
            case TELA_DESCADASTRAR:
                ...
                do
                {
                    printf("Digite um indicie de contato para descadastrar: de 0 até %d\n", i -1);
                    scanf("%d", &indice);
                    int c = 0;
                    while ((c = getchar()) != '\n' && c != EOF) {}
